...
from product.views.reviews import create_review, ReviewUpdateView, ReviewDeleteView
...
urlpatterns = [
    ...
    path('products/<int:pk>/review/delete', ReviewDeleteView.as_view(), name='review_delete')
]
